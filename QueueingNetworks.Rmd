...
Suppose we have the following routing matrix and we need to solve $vR = v$ such that $\sum v_i = 1$. We can use the function solve.routing() to accomplish this. The only input necessary is the routing matrix. 
