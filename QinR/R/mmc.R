...
#'
#' @examples
#' # M/M/1 Markovian model
#' mm1.queue <- mmc.summary(
#'   lambda = 4, mu = 4.4545, c = 1,
#'   tol = 0.01,
#'   plot_pn = TRUE,
#'   plot_waitQ = TRUE,
#'   plot_waitSys = TRUE
...
#'
#'
#' # Markovian queueing models with parallel channels: M/M/c/<U+221E>/<U+221E> queues
#'
