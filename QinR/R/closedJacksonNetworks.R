...
#'
#' @return Returns vR=v such that  <U+2211>vi=1
#' @export
#'
#' @examples R <- matrix(c(
#'   0, 0.75, 0.25, 0.6666666667, 0, 0.3333333333,
#'   1, 0, 0
...
#' is set to true, the function uses Buzen<U+2019>s algorithm to solve for the summary statistics.
